...
# for t in [0.0002,0.00025,0.0003,0.00035,0.0004,0.00045,0.0005]:
# for t in [0.00035,0.0004,0.00045,0.0005]:
for t in [0,0.00045,0.0005]:
    print('!!!!!!!!!!!!!!!!!!!!!, ',t)
    new_feat_imp_df = pd.read_csv('0.7427262249215246_feat_xgb_baseline.csv')
    new_feat_imp_df = new_feat_imp_df[new_feat_imp_df['importance']>=t]
